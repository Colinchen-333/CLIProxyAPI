...
// codexRawArray preserves each item's wire representation and insertion order.
// Each byte is copied once, independently of the number of history items/tools.
func codexRawArray(items [][]byte) []byte {
	size := 2
